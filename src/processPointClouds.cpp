...
typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
{
    ...
    std::cout << "Original point number = " << cloud->points.size() << std::endl;
    std::cout << "Filtered point number = " << cloudFiltered->points.size() << std::endl;
...
std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::SegmentPlaneCustom(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold)
{
    ...
    Ransac<PointT> segRansac;
    std::unordered_set<int> inliers = segRansac.Ransac3D(cloud, maxIterations, distanceThreshold);
...
std::vector<typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::ClusteringCustom(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
{
    ...
    // TODO:: Fill in the function to perform euclidean clustering to group detected obstacles
    ClusterCustom<PointT>* ec = new ClusterCustom<PointT>;
    std::vector<typename pcl::PointCloud<PointT>::Ptr> clusters = ec->EuclideanCluster(cloud, clusterTolerance, minSize, maxSize);
